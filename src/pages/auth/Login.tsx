        ...
        >
          <Box sx={{ maxWidth: 420, mx: 'auto', width: '100%' }}>
            ...
            {isAuthenticated && user && (
              <Box sx={{ mb: 3, p: 2.5, borderRadius: '8px', border: '1px solid #496A57', backgroundColor: '#E8EFE9' }}>
                <Typography variant="subtitle2" sx={{ fontWeight: 600, color: '#304B3A', mb: 0.5 }}>
                ...
                <Stack direction="row" spacing={1.5}>
                  ...
                  <Button
                    ...
                    variant="outlined"
                    onClick={() => logout()}
                    sx={{ borderColor: '#304B3A', color: '#304B3A', textTransform: 'none', '&:hover': { backgroundColor: '#FFFFFF' } }}
                  >
